...
const PrimaryDraw: React.FC<Props> = ({ children }) => {
    ...
    // If you happen to have issues later, what he did is seperate the functions
    // One opens and setOpen to true. The other closes and setOpen to false
    const toggleDraw = () => {
        setOpen(!open);
    }
        ...
        >
            <Box>
                <Box sx={{position: "absolute",top: 0, right: 0, p: 0, width: open ? "auto" : "100%"}}>
                    <DrawerToggle open={open} toggleDraw={toggleDraw} />
                </Box>
